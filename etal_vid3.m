...
i_d = 71 + scan.s_offset -0.5 + 5; % height of the beginnig of the calibration (71 cool) / +5 to avoid the tube 3d piece
i_f = i_d + plage_capt + 4 -5; %-5 pour compenser le +5 juste avant
